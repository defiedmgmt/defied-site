...
export async function writeOutreachProspectFull(sheets, spreadsheetId, row, { name, contact, songs }) {
  const data = [
    { range: `'${OUTREACH_TAB}'!A${row}`, values: [[name]] },
    { range: `'${OUTREACH_TAB}'!B${row}`, values: [[contact || ""]] },
  ];
...
export { DATA_START_ROW, WRITER_TAB_RE, TEMPLATE_TAB_NAME, OUTREACH_TAB, ADVANCE_TAB };
